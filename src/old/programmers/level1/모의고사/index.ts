export function solution(answers: number[]) {
	...
	const answer1Count = answers.filter((answer, index) => answer === answer1[index % answer1.length]).length;
	const answer2Count = answers.filter((answer, index) => answer === answer2[index % answer2.length]).length;
	const answer3Count = answers.filter((answer, index) => answer === answer3[index % answer3.length]).length;
